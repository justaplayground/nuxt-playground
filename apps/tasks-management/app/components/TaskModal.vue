<template>
  <div class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4" @click.self="$emit('close')">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-xl border border-gray-200">
      <!-- Modal Header -->
      ...
      <form @submit.prevent="handleSubmit" class="p-6">
        ...
        <div class="flex items-center justify-between pt-6 mt-6 border-t border-gray-200">
          <button
            type="button"
            class="px-3 py-1.5 text-red-600 hover:text-red-700 hover:bg-red-50 rounded text-sm transition-colors"
            @click="handleDelete"
          >
            Delete Task
          </button>
          ...
          <div class="flex items-center gap-3">
            ...
            <button
              type="submit"
              class="px-4 py-1.5 bg-emerald-600 text-white rounded text-sm hover:bg-emerald-700 focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-colors"
